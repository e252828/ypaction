...
This guide walks through testing the entire Web Search Skill integration with YP Action.

## Prerequisites

1. YP Action built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with YP Action.

**Steps:**

1. Start YP Action in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of YP Action launch.
...
1. Open a terminal while YP Action is running
...
**Objective:** Verify graceful shutdown of services when YP Action quits.

**Steps:**

1. With YP Action running and searches completed, quit the application
...
1. Start YP Action (ensure headless is false in config)
...
- ✅ Server auto-starts with YP Action
