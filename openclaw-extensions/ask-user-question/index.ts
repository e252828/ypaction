 ...
 * and waits for the user's response via an HTTP callback to YP Action.
 *
 * This enables delete-confirmation modals on the YP Action desktop app
...
const plugin = {
  ...
  description: 'Structured user confirmation tool for YP Action desktop.',,
  configSchema: {
  ...
  register(api: OpenClawPluginApi) {
    ...
    api.registerTool((ctx) => {
      // Only enable for YP Action desktop sessions (sessionKey starts with 'agent:main:lobsterai:').
