...
const WIN_INBOUND = String.raw`C:\Users\yangwn\AppData\Roaming\YP Action\openclaw\state\media\inbound`;
const MAC_INBOUND = '/Users/yangwn/Library/Application Support/YP Action/openclaw/state/media/inbound';
