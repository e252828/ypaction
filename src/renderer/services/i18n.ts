...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    aboutBasedOnLobsterAI: '本应用基于LobsterAI开发@2026',
    testMode: '测试模式',
    theme: '主题',
    appearance: '外观',
    language: '语言',
    ...
    authQuotaExhausted:
      '今日免费额度已用完。您可以登录 YP Action Portal 购买套餐或积分包继续使用，或在设置中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    authCreditsUnit: '积分',
    authMonthRemainingQuota: '本月剩余额度',
    authMonthUsedTokens: '本月已用Token',
    authMonthUsedQuota: '本月已用额度',
    authMonthlyQuota: '账户月额度',
    authQuotaUnlimited: '不限量',
    authExpiresAt: '有效期至',
    authLearnMore: '了解更多',
    ...
    coworkWorkingDirectoryHint: 'YP Action 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 YP Action 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 YP Action 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'YP Action 使用模型设置中的当前模型与提供商配置。',
    coworkModelSettingsAction: '前往模型设置',
    modelGroupServer: '悦普模型',
    ...
    coworkConfigSaveFailed: '保存 YP Action 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: 'YP Action 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: 'YP Action 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    browserWebAccessDescription: '使用 YP Action 独立浏览器，管理网页打开方式和访问规则。',
    ...
    browserProfileManagedDescription: 'YP Action 启动一个专用浏览器，稳定、干净。',
    ...
    browserFollowGlobalProxyDescription: '默认开启。关闭后仅作为 YP Action 配置保留，当前版本仍受浏览器自身代理设置影响。',
    ...
    browserBlockedHostnamesDescription: 'YP Action 不会打开这些网站',
    browserHostnameListEmpty: '尚未添加域名',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: '添加已屏蔽域名',
    browserAddBlockedHostnameDescription: '这意味着 YP Action 不会打开此 URL',
    browserAddAllowedHostnameTitle: '添加允许域名',
    browserAddAllowedHostnameDescription: '这意味着 YP Action 可以打开此域名',
    ...
    // 隐私协议弹窗
    privacyDialogTitle: '网易有道YP Action服务协议',
    privacyDialogDesc: '在使用网易有道YP Action之前，请您仔细阅读{link}内容，并进行确认。',
    privacyDialogLinkText: '网易有道YP Action服务协议',
    privacyDialogAccept: '我已阅读并同意',
    privacyDialogReject: '拒绝',
    welcomeTitle: '欢迎使用YP Action',
  ...
  en: {
    ...
    aboutBasedOnLobsterAI: 'Built on LobsterAI @2026',
    testMode: 'Test Mode',
    theme: 'Theme',
    ...
    authQuotaExhausted:
      'Daily free quota exhausted. Visit YP Action Portal to purchase a plan or credits, or configure your own API Key in Settings.',
    ...
    authMonthRemainingQuota: 'Monthly Remaining',
    authMonthUsedTokens: 'Monthly Tokens Used',
    authMonthUsedQuota: 'Monthly Spend',
    authMonthlyQuota: 'Monthly Quota',
    authQuotaUnlimited: 'Unlimited',
    ...
    // YP Action
    cowork: 'YP Action',
    coworkSettings: 'YP Action Settings',
    ...
    coworkWorkingDirectoryHint: 'YP Action will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for YP Action...',
    coworkSystemPromptHint: "Optional system prompt to customize YP Action's behavior",
    ...
    coworkModelSettingsHint:
      'YP Action uses the current model and provider configuration from Model Settings.',
    coworkModelSettingsAction: 'Go to Model Settings',
    modelGroupServer: 'Yuepu Models',
    ...
    coworkConfigSaveFailed: 'Failed to save YP Action Settings. Please try again.',
    ...
    coworkPermissionDescription: 'YP Action is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: 'YP Action needs your input',
    ...
    browserWebAccessDescription: 'Use the YP Action separate browser and manage page access rules.',
    ...
    browserProfileManagedDescription: 'YP Action starts a dedicated browser that is stable and clean.',
    ...
    browserFollowGlobalProxyDescription: 'Enabled by default. Turning it off is stored for YP Action, but this version can still be affected by the browser proxy settings.',
    ...
    browserBlockedHostnamesDescription: 'YP Action will not open these websites',
    browserHostnameListEmpty: 'No domains added yet',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: 'Add blocked domain',
    browserAddBlockedHostnameDescription: 'This means YP Action will not open this URL',
    browserAddAllowedHostnameTitle: 'Add allowed domain',
    browserAddAllowedHostnameDescription: 'This means YP Action can open this domain',
    ...
    // Privacy dialog
    privacyDialogTitle: 'NetEase Youdao YP Action Terms of Service',
    privacyDialogDesc:
      'Before using NetEase Youdao YP Action, please carefully read the {link} and confirm.',
    privacyDialogLinkText: 'NetEase Youdao YP Action Terms of Service',
    privacyDialogAccept: 'I have read and agree',
    privacyDialogReject: 'Decline',
    welcomeTitle: 'Welcome to YP Action',
